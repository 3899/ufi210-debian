...
USERDATA_PARTITION_SECTORS=3602399
SYSTEM_PARTITION_START=461920
CACHE_PARTITION_START=3044040
USERDATA_PARTITION_START=3803136
LARGE_ROOTFS_SECTORS=6643264
LARGE_ROOTFS_SIZE=3401351168
LARGE_ROOTFS_FILESYSTEM_SIZE=3401351168
LARGE_ROOTFS_TABLE="0 2516584 linear PARTLABEL=system 0;2516584 524288 linear PARTLABEL=cache 0;3040872 3602392 linear PARTLABEL=userdata 0"
...
DATA_IMAGE="$OUT_DIR/data.img"
BOOT_IMAGE="$OUT_DIR/boot.img"
